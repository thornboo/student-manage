...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Class',
            fields=[
                ('class_id', models.CharField(max_length=5, primary_key=True, serialize=False, verbose_name='班级编号')),
        ...
        migrations.CreateModel(
            name='Department',
            fields=[
                ('department_id', models.CharField(max_length=5, primary_key=True, serialize=False, verbose_name='学院编号')),
